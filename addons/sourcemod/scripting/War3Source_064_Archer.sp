...
//Improved Bow
new Float:ChanceArr[]={0.0, 0.1, 0.14 ,0.18, 0.22, 0.26, 0.3, 0.34, 0.4};
...
public OnRaceChanged(client,oldrace,newrace)
{
	...
	if(newrace==thisRaceID){
		War3_WeaponRestrictTo(client,thisRaceID,"weapon_ssg08,weapon_smokegrenade");
...
public InitPassive(client)
{
	if(War3_GetRace(client)==thisRaceID){
		...
		if(GetRandomFloat(0.0,1.0)<ChanceArr[skill]){
			War3_WeaponRestrictTo(client,thisRaceID,"weapon_scar20,weapon_smokegrenade");
