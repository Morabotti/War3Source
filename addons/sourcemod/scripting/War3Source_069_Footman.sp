...
new Float:DefArr[9] =  { 0.0, 0.20, 0.22, 0.24, 0.26, 0.28, 0.30, 0.32, 0.35 };

//Mithril Forged Sword
new Float:DmgArr[9] =  { 1.0, 1.03, 1.06, 1.09, 1.12, 1.15, 1.18, 1.21, 1.24 };

//Mithril Plating
new Float:DmgRed[9] =  { 0.0, 0.02, 0.04, 0.06, 0.08, 0.1, 0.12, 0.14, 0.16 };
