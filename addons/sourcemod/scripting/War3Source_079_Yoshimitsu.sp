...
new Float:ElectricGravity[9] = { 1.0, 0.90, 0.85, 0.8, 0.75, 0.7, 0.68, 0.65, 0.6 };
new Float:JumpMultiplier[9] = { 1.0, 2.8, 2.9, 3.0, 3.1, 3.2, 3.3, 3.4, 3.5 };
new g_iDamageBonus[9] =  { 0, 10, 18, 26, 34, 42, 50, 58, 60 };

new Float:ult_cooldown=15.0;
new playerkills[MAXPLAYERS];

new g_iHarakiriHealth[9] =  { 60, 50, 40, 30, 20, 10, 0, -10, -20 };
new Float:g_fHarakiriDamage[9] =  { 0.0, 0.08, 0.16, 0.24, 0.32, 0.40, 0.48, 0.56, 0.64 };

new Float:ult_delay[9] =  { 0.0, 6.5, 6.0, 5.5, 5.0, 4.0, 3.0, 2.0, 1.95 };
...
public OnWar3LoadRaceOrItemOrdered(num)
{
    ...
    SKILL_WINDMILL=War3_AddRaceSkill(thisRaceID,"Windmill","Use your mechanical arm to fly.",false,8);
    SKILL_DAMAGE=War3_AddRaceSkill(thisRaceID,"Soul Edge","Blood awakens the demon within (gain power per kill)",false,8);
    SKILL_HARAKIRI=War3_AddRaceSkill(thisRaceID,"Harakiri","Add your own blood to the sword for extra power",false,8);
    ULT_RESPAWN=War3_AddRaceSkill(thisRaceID,"Manji Ninjitsu","Teleport yourself back to spawn fully healed (+ultimate)",true,8);
...
public OnMapStart()
{
	AddFileToDownloadsTable("materials/mora-wcs/sprites/orangelight1.vmt");
	AddFileToDownloadsTable("materials/mora-wcs/sprites/orangelight1.vtf");
	...
	BeamSprite=PrecacheModel("materials/mora-wcs/sprites/orangelight1.vmt");
}
