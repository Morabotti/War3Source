...
new Float:fHealwaveMaxDistance[9] = {0.0, 100.0, 130.0, 160.0, 190.0, 220.0, 250.0, 280.0, 300.0};
new Float:fHeallineMaxDistance[9] = {0.0, 500.0, 550.0, 600.0, 650.0, 700.0, 750.0, 800.0 ,850.0};
new Float:fOverchargeMaxDistance[9] = {0.0, 250.0, 350.0, 450.0, 550.0, 650.0, 750.0, 850.0, 950.0};
new Float:fOverchargeSeparationFactor = 1.5;
new Float:fHospitalMaxDistance[9] = {0.0, 100.0, 130.0, 160.0, 190.0, 220.0, 250.0, 280.0, 300.0};

//new Float:fHealwaveCooldown[] = {0.0, 12.0, 10.0, 8.0, 6.0};
new Float:fHeallineCooldown[9] = {0.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0};
new Float:fOverchargeCooldown[9] = {0.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0};
new Float:fHospitalCooldown[9] = {0.0, 40.0, 37.0, 34.0, 31.0, 28.0, 25.0, 22.0, 19.0};

//Healwave
new iHealwaveMaxWaves[9] = {0, 3, 4, 4, 5, 5, 6, 6, 7};
//new iHealwaveHealHP[] = {0, 5, 10, 15, 20};
new iHealwaveHealHP[9] =  { 0, 3, 4, 5, 6, 7, 8, 9, 10 };
new Float:fHealwaveTimerRepeat = 1.0;

//Healline
new iHeallineHealHP[9] = {0, 15, 20, 25, 30, 35, 40, 45, 50};
new Float:fMarkTimerRepeat = 0.25;

//Overcharge
new Float:fOverchargeDuration[9] = {0.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0};
new Float:fOverchargeDamageMod[9] = {0.0, 0.03, 0.06, 0.09, 0.12, 0.15, 0.18, 0.21, 0.25};
...
public OnWar3LoadRaceOrItemOrdered(num)
{
    ...
    SKILL_HEALWAVE = War3_AddRaceSkill(thisRaceID, "Healing Wave (passive)", "Heal nearby allies every second.", false, 8);
    SKILL_HEALLINE = War3_AddRaceSkill(thisRaceID, "Bandages (ability)", "Heal a nearby visible ally", false, 8);
    SKILL_OVERCHARGE = War3_AddRaceSkill(thisRaceID, "Overcharge (ability1)", "Increase a nearby ally's damage and run as fast as them.", false, 8);
    ULT_HOSPITAL = War3_AddRaceSkill(thisRaceID, "Hospital (ultimate)", "Heal an ally and offer to send them home.", true, 8);
    
    War3_CreateRaceEnd(thisRaceID);
    
    W3SkillCooldownOnSpawn(thisRaceID, SKILL_HEALWAVE, 10.0, true);
    W3SkillCooldownOnSpawn(thisRaceID, SKILL_HEALLINE, 8.0, true);
    W3SkillCooldownOnSpawn(thisRaceID, SKILL_OVERCHARGE, 8.0, true);
...
public OnMapStart()
{
	AddFileToDownloadsTable("materials/mora-wcs/sprites/hydraspinalcord.vtf");
	AddFileToDownloadsTable("materials/mora-wcs/sprites/hydraspinalcord.vmt");
	...
	HealSprite = PrecacheModel("materials/mora-wcs/sprites/hydraspinalcord.vmt");
