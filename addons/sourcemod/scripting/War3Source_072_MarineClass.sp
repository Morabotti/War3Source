...
new Float:BeaconChance[9] = { 0.0, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.8, 0.85 };
new Float:DamageChance[9] = { 0.0, 0.15, 0.18, 0.20, 0.22, 0.25, 0.28, 0.30, 0.35 };
new StrikeDamage[9] = { 0, 10, 15, 20, 23, 25, 28, 30, 35 };
new String:ult_sound[] = "*mora-wcs/weapons/morabotti/stinger_fire1.mp3";
...
public OnMapStart()
{
	AddFileToDownloadsTable("sound/mora-wcs/weapons/morabotti/stinger_fire1.mp3");
	...
	UltSprite = PrecacheModel( "materials/mora-wcs/sprites/lgtning.vmt" );
...
public OnWar3LoadRaceOrItemOrdered(num)
{
	...
	SKILL_GUN = War3_AddRaceSkill( thisRaceID, "Gun", "You spawning with a MP5Navy/Famas/M4A1/M249", false );	//oltava 4
	SKILL_TRAINING = War3_AddRaceSkill( thisRaceID, "Aim Training", "You know where to aim and can make 75%-120% extra dmg by 35%-50% chance", false, 8 );	
	SKILL_BEACON = War3_AddRaceSkill( thisRaceID, "Hot Spot", "You got 50%-80% of makeing a beacon around enemy", false, 8 );
	ULT_ART = War3_AddRaceSkill( thisRaceID, "Artillery", "You can hit an enemy from everywhere whit a artillery cannon and gain 30 hp.", true, 8 );
