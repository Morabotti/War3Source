...
// Chance/Data Arrays
new Float:BeaconChance[9] = { 0.0, 0.05, 0.08, 0.11, 0.14, 0.17, 0.20, 0.23, 0.26 };
new Float:DisgChance[9] = { 0.0, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60 };
new Float:UltDuration[9] = { 0.0, 1.0, 1.3, 1.6, 1.9, 2.2, 2.5, 2.8, 3.0 };
new Float:UltBreakDelay[9] = { 0.0, 0.6, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4 };
...
new Float:GoldChance[9] = { 0.0, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.5 };
new GoldQuantity = 2;
new XPMin[9] = { 0, 10, 16, 22, 28, 34, 40, 46, 50 };
new XPMax[9] = { 0, 20, 32, 44, 56, 68, 80, 92, 100 };
...
public OnWar3LoadRaceOrItemOrdered(num)
{
	...
	SKILL_SKIN = War3_AddRaceSkill( thisRaceID, "Disguise", "You may spawn and look like the enemy", false, 8 );
	SKILL_XP = War3_AddRaceSkill( thisRaceID, "Scope Master", "You get 10-100 XP and maybe 2 gold on a scout kill", false, 8 );
	SKILL_BEACON = War3_AddRaceSkill( thisRaceID, "One bullet one kill", "You beacon enemies in order to track them", false, 8 );
	SKILL_HIDE = War3_AddRaceSkill( thisRaceID, "Sniper", "Go invisible for 0.5 + (0.5 x level) seconds when hit\nAfter 0.5 + (0.1 x level) seconds shooting will break invis", false, 8 );
