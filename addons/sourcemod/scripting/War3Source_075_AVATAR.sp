...
// Chance/Data Arrays
// skill 1
new Float:FireChance[9] = { 0.0, 0.1, 0.13, 0.16, 0.19, 0.22, 0.25, 0.28, 0.31 };

// skill 2
new Float:SlowChance[9] = { 0.0, 0.1, 0.13, 0.16, 0.19, 0.22, 0.25, 0.28, 0.31 };
new Float:SlowSpeed[9] = { 1.0, 0.85, 0.80, 0.75, 0.70, 0.65, 0.60, 0.55, 0.50 };
new Float:SlowDuration[9] = { 0.0, 0.3, 0.6, 0.9, 1.2, 1.5, 1.8, 2.1, 2.5 };

// skill 3
new Float:QuakeChance[9] = { 0.0, 0.1, 0.13, 0.16, 0.19, 0.22, 0.25, 0.28, 0.31 };

// skill 4
new Float:Duration[9] = { 0.0, 3.0, 4.0, 5.0, 6.0, 7.0, 8.0, 9.0, 10.0 };

// Sounds
new String:UltSound[] = "*mora-wcs/weapons/Morabotti/explode5.mp3";
new String:UltSound_FullPath[] = "sound/mora-wcs/weapons/Morabotti/explode5.mp3";
...
public OnMapStart()
{	
	AddFileToDownloadsTable(UltSound_FullPath);
	AddFileToDownloadsTable("materials/mora-wcs/sprites/tp_beam001.vmt");
	AddFileToDownloadsTable("materials/mora-wcs/sprites/bluelaser1.vtf");
	AddFileToDownloadsTable("materials/mora-wcs/sprites/physbeam.vtf");
	AddFileToDownloadsTable("materials/mora-wcs/models/effects/splodecard2_sheet.vmt");
	AddFileToDownloadsTable("materials/mora-wcs/models/effects/splodecard2_sheet.vtf");
	...
	SplodeCardSprite = PrecacheModel( "materials/mora-wcs/models/effects/splodecard2_sheet.vmt" );
	YellowFlareSprite = PrecacheModel( "materials/mora-wcs/sprites/yellowflare.vmt" );
	PrecacheSoundAny( UltSound );
}
...
public OnWar3LoadRaceOrItemOrdered(num)
{
	...
	SKILL_FIRE = War3_AddRaceSkill( thisRaceID, "Fire", "Chance to burn your enemies.", false, 8 );
	SKILL_WATER = War3_AddRaceSkill( thisRaceID, "Water", "Wet your enemies so much they slow down.", false, 8 );
	SKILL_EARTH = War3_AddRaceSkill( thisRaceID, "Earth", "Shake them like you just don't care.", false, 8 );
	ULT_WIND = War3_AddRaceSkill( thisRaceID, "Wind", "Run like the wind (fast and invisible).", true, 8 );
...
public OnUltimateCommand( client, race, bool:pressed )
{
	if( race == thisRaceID && pressed && IsPlayerAlive( client ) && !Silenced( client ) )
	{
		...
		if( ult_level > 0 )
		{
			...
			{
				EmitSoundToAllAny( UltSound, client );
